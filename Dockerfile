...
CMD ["bash", "-c", "uv run mcpdoc --urls LangGraph:https://langchain-ai.github.io/langgraph/llms.txt CrewAI:https://docs.crewai.com/llms.txt --transport sse --port 8082 --host localhost & uv run chainlit run app.py -h --port 7860 --host 0.0.0.0"]
